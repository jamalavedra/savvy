...
In Spain, where many of our users take calls in Spanish or Catalan, recording a conversation you take part in is generally treated differently from recording one you are not part of, and sharing a recording with third parties is a separate question again. The pattern repeats across countries: being a participant helps, telling people helps more, and passing the recording on is where rules tighten.

None of this is a substitute for checking your own situation. It is enough to know that "I was on the call" is not a universal answer.

## Rules that are not laws

Two more layers apply before you get to legislation.

**Your employer's policy.** Many companies restrict AI assistants in customer calls, or require a specific disclosure. Some ban them. Check before the first call, not after.

**The other side's policy.** Some organisations do not allow their calls to be transcribed by third-party tools at all. If a counterparty asks you to turn it off, turn it off. In Savvy, stopping the meeting stops the capture.

## What to tell the other side

Say it at the start, in one breath, and then move on. Something like:

> "Before we begin: I use a notes assistant that transcribes the call on my machine so I can stay on our documents instead of typing. The transcript stays with me and is deleted after 30 days. Is that all right with you?"

If they say yes, you are done. If they hesitate, offer to switch it off, and mean it. If they say no, stop the meeting in Savvy and take notes by hand. A call that starts with a small courtesy tends to go better than one that starts with a discovered recording.

Do not bury the disclosure in a calendar invite footer and count that as consent. Some people will not read it, and the ones who do will notice you did not say it out loud.

## Etiquette after the call
...
Some products in this category sell the ability to be invisible on a screen share, so that nobody knows you are using an assistant. We do not, and the [FAQ](/#faq) says so plainly.
